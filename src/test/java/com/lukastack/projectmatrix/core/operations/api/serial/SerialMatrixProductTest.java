...
class SerialMatrixProductTest {
    ...
    private SerialMatrixProduct productImpl;
    ...
    @Test
    void matMul_correctEquations_squareMatrix() throws ExecutionException, InterruptedException {
    ...
    void matMul_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> productImpl.matMul(matrixFirst, matrixSecond));
    }
