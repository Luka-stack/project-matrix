...
class IndividualNumJvTest {
    ...
    private IndividualNumJv individualNumJv;

    @BeforeEach
    void setUp() {
        individualNumJv = new IndividualNumJv();
    }
    ...
    void add_Matrix_v_Matrix_CorrectEquation() {
        ...
        var result = individualNumJv.add(leftMatrix, rightMatrix);
    ...
    void add_Matrix_x_Matrix_RowImplementation_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> individualNumJv.add(leftMatrix, rightMatrix));
    }
    ...
    void add_Matrix_v_Scalar_CorrectEquation() {
        ...
        var result = individualNumJv.add(leftMatrix, scalar);
    ...
    void sub_Matrix_v_Matrix_CorrectEquation() {
        ...
        var result = individualNumJv.sub(leftMatrix, rightMatrix);
    ...
    void sub_Matrix_x_Matrix_RowImplementation_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> individualNumJv.sub(leftMatrix, rightMatrix));
    }
    ...
    void sub_Matrix_v_Scalar_CorrectEquation() {
        ...
        var result = individualNumJv.sub(leftMatrix, scalar);
    ...
    void mul_Matrix_v_Matrix_CorrectEquation() {
        ...
        var result = individualNumJv.mul(leftMatrix, rightMatrix);
    ...
    void mul_Matrix_x_Matrix_RowImplementation_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> individualNumJv.mul(leftMatrix, rightMatrix));
    }
    ...
    void mul_Matrix_v_Scalar_CorrectEquation() {
        ...
        var result = individualNumJv.mul(leftMatrix, scalar);
    ...
    void div_Matrix_v_Matrix_CorrectEquation() {
        ...
        var result = individualNumJv.div(leftMatrix, rightMatrix);
    ...
    void div_Matrix_x_Matrix_RowImplementation_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> individualNumJv.div(leftMatrix, rightMatrix));
    }
    ...
    void div_Matrix_v_Scalar_CorrectEquation() {
        ...
        var result = individualNumJv.div(leftMatrix, scalar);
    ...
    void pow_Matrix_v_Matrix_CorrectEquation() {
        ...
        var result = individualNumJv.pow(leftMatrix, rightMatrix);
    ...
    void pow_Matrix_x_Matrix_RowImplementation_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> individualNumJv.pow(leftMatrix, rightMatrix));
    }
    ...
    void pow_Matrix_v_Scalar_CorrectEquation() {
        ...
        var result = individualNumJv.pow(leftMatrix, scalar);
    ...
    void root_Matrix_v_Matrix_CorrectEquation() {
        ...
        var result = individualNumJv.root(leftMatrix, rightMatrix);
    ...
    void root_Matrix_x_Matrix_RowImplementation_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> individualNumJv.root(leftMatrix, rightMatrix));
    }
    ...
    void root_Matrix_v_Scalar_CorrectEquation() {
        ...
        var result = individualNumJv.root(leftMatrix, scalar);
    ...
    void matMul_CorrectEquation() {
        ...
        var result = individualNumJv.matMul(leftMatrix, rightMatrix);
    ...
    void matMul_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> individualNumJv.matMul(leftMatrix, rightMatrix));
    }

    @Test
    void builder_CannotCreateBuilder_ThrowsCreationalException() {

        Assertions.assertThrows(CreationalException.class, () -> new IndividualNumJv.Builder().build());
    }

    @Test
    void builder_createsInstance_OperationWorks() {

        var newInstance = new IndividualNumJv.Builder()
                .operationsImpl(new IndividualDefaultOperation())
    ...
    void param_WaitForResult_false_NotBlockingMainThread() {
        ...
        var newInstance2 = new IndividualNumJv.Builder()
                .operationsImpl(new IndividualDefaultOperation())
                .matrixProductImpl(new IndividualDefaultMatrixProduct())
                .waitForResult(true)
                .build();
