...
class GroupNumJvTest {
    ...
    private GroupNumJv groupNumJv;

    @BeforeEach
    void setUp() {
        groupNumJv = new GroupNumJv();
    }
    ...
    void add_Matrix_v_Matrix_CorrectEquation() {
        ...
        var result = groupNumJv.add(leftMatrix, rightMatrix);
    ...
    void add_Matrix_x_Matrix_RowImplementation_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> groupNumJv.add(leftMatrix, rightMatrix));
    }
    ...
    void add_Matrix_v_Scalar_CorrectEquation() {
        ...
        var result = groupNumJv.add(leftMatrix, scalar);
    ...
    void sub_Matrix_v_Matrix_CorrectEquation() {
        ...
        var result = groupNumJv.sub(leftMatrix, rightMatrix);
    ...
    void sub_Matrix_x_Matrix_RowImplementation_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> groupNumJv.sub(leftMatrix, rightMatrix));
    }
    ...
    void sub_Matrix_v_Scalar_CorrectEquation() {
        ...
        var result = groupNumJv.sub(leftMatrix, scalar);
    ...
    void mul_Matrix_v_Matrix_CorrectEquation() {
        ...
        var result = groupNumJv.mul(leftMatrix, rightMatrix);
    ...
    void mul_Matrix_x_Matrix_RowImplementation_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> groupNumJv.mul(leftMatrix, rightMatrix));
    }
    ...
    void mul_Matrix_v_Scalar_CorrectEquation() {
        ...
        var result = groupNumJv.mul(leftMatrix, scalar);
    ...
    void div_Matrix_v_Matrix_CorrectEquation() {
        ...
        var result = groupNumJv.div(leftMatrix, rightMatrix);
    ...
    void div_Matrix_x_Matrix_RowImplementation_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> groupNumJv.div(leftMatrix, rightMatrix));
    }
    ...
    void div_Matrix_v_Scalar_CorrectEquation() {
        ...
        var result = groupNumJv.div(leftMatrix, scalar);
    ...
    void pow_Matrix_v_Matrix_CorrectEquation() {
        ...
        var result = groupNumJv.pow(leftMatrix, rightMatrix);
    ...
    void pow_Matrix_x_Matrix_RowImplementation_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> groupNumJv.pow(leftMatrix, rightMatrix));
    }
    ...
    void pow_Matrix_v_Scalar_CorrectEquation() {
        ...
        var result = groupNumJv.pow(leftMatrix, scalar);
    ...
    void root_Matrix_v_Matrix_CorrectEquation() {
        ...
        var result = groupNumJv.root(leftMatrix, rightMatrix);
    ...
    void root_Matrix_x_Matrix_RowImplementation_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> groupNumJv.root(leftMatrix, rightMatrix));
    }
    ...
    void root_Matrix_v_Scalar_CorrectEquation() {
        ...
        var result = groupNumJv.root(leftMatrix, scalar);
    ...
    void matMul_CorrectEquation() {
        ...
        var result = groupNumJv.matMul(leftMatrix, rightMatrix);
