...
class SerialNumJvTest {
    ...
    private SerialNumJv serialNumJv;

    @BeforeEach
    void setUp() {
        serialNumJv = new SerialNumJv();
    }
    ...
    void add_Matrix_v_Matrix_CorrectEquation() {
        ...
        var result = serialNumJv.add(leftMatrix, rightMatrix);
    ...
    void add_Matrix_x_Matrix_RowImplementation_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> serialNumJv.add(leftMatrix, rightMatrix));
    }
    ...
    void add_Matrix_v_Scalar_CorrectEquation() {
        ...
        var result = serialNumJv.add(leftMatrix, scalar);
    ...
    void sub_Matrix_v_Matrix_CorrectEquation() {
        ...
        var result = serialNumJv.sub(leftMatrix, rightMatrix);
    ...
    void sub_Matrix_x_Matrix_RowImplementation_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> serialNumJv.sub(leftMatrix, rightMatrix));
    }
    ...
    void sub_Matrix_v_Scalar_CorrectEquation() {
        ...
        var result = serialNumJv.sub(leftMatrix, scalar);
    ...
    void mul_Matrix_v_Matrix_CorrectEquation() {
        ...
        var result = serialNumJv.mul(leftMatrix, rightMatrix);
    ...
    void mul_Matrix_x_Matrix_RowImplementation_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> serialNumJv.mul(leftMatrix, rightMatrix));
    }
    ...
    void mul_Matrix_v_Scalar_CorrectEquation() {
        ...
        var result = serialNumJv.mul(leftMatrix, scalar);
    ...
    void div_Matrix_v_Matrix_CorrectEquation() {
        ...
        var result = serialNumJv.div(leftMatrix, rightMatrix);
    ...
    void div_Matrix_x_Matrix_RowImplementation_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> serialNumJv.div(leftMatrix, rightMatrix));
    }
    ...
    void div_Matrix_v_Scalar_CorrectEquation() {
        ...
        var result = serialNumJv.div(leftMatrix, scalar);
    ...
    void pow_Matrix_v_Matrix_CorrectEquation() {
        ...
        var result = serialNumJv.pow(leftMatrix, rightMatrix);
    ...
    void pow_Matrix_x_Matrix_RowImplementation_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> serialNumJv.pow(leftMatrix, rightMatrix));
    }
    ...
    void pow_Matrix_v_Scalar_CorrectEquation() {
        ...
        var result = serialNumJv.pow(leftMatrix, scalar);
    ...
    void root_Matrix_v_Matrix_CorrectEquation() {
        ...
        var result = serialNumJv.root(leftMatrix, rightMatrix);
    ...
    void root_Matrix_x_Matrix_RowImplementation_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> serialNumJv.root(leftMatrix, rightMatrix));
    }
    ...
    void root_Matrix_v_Scalar_CorrectEquation() {
        ...
        var result = serialNumJv.root(leftMatrix, scalar);
    ...
    void matMul_CorrectEquation() {
        ...
        var result = serialNumJv.matMul(leftMatrix, rightMatrix);
    ...
    void matMul_WrongDimensions_ThrowsDimensionException() {
        ...
        Assertions.assertThrows(DimensionException.class, () -> serialNumJv.matMul(leftMatrix, rightMatrix));
    }

    @Test
    void builder_CannotCreateBuilder_ThrowsCreationalException() {

        Assertions.assertThrows(CreationalException.class, () -> new SerialNumJv.Builder().build());
    }

    @Test
    void builder_createsInstance_OperationWorks() {

        var newInstance = new SerialNumJv.Builder()
                .operationsImpl(new SerialDefaultOperation())
