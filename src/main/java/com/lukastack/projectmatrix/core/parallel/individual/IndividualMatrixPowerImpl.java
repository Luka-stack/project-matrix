...
public class IndividualMatrixPowerImpl<E extends Matrix> implements IParallelMatrixPower, ParallelElementWiseMatrixEquation {
    ...
    public Matrix power(Matrix leftMatrix, double scalar, ThreadPoolExecutor taskPool) {
        ...
        this.operate(leftMatrix, promotedScalar, result, taskPool, Math::pow);
