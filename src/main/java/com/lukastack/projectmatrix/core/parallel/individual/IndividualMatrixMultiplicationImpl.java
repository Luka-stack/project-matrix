...
public class IndividualMatrixMultiplicationImpl<E extends Matrix> implements IParallelMatrixMultiplication, ParallelElementWiseMatrixEquation {

    private final Class<E> clazz;

    public IndividualMatrixMultiplicationImpl(Class<E> clazz) {
